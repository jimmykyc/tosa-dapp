! function (e, t) {
    ...
    var i = (t.prototype.getBars = function (e, t, r) {
        var s = this,
            o = {
                symbol: e.ticker || "",
                resolution: t,
        ...
        return void 0 !== r.countBack && (o.countback = r.countBack), void 0 !== e.currency_code && (o.currencyCode = e.currency_code), new Promise(function (a, u) {
            s._requester.sendRequest(s._datafeedUrl, "history", o).then(function (e) {
    ...
    var a = (s.prototype.subscribeBars = function (e, t, r, s) {
        ...
        if (!(0 < this._requestsPending)) {
            ...
            var e, r, s = this;
            for (e in this._subscribers) r = e, s._requestsPending += 1, s._updateDataForSubscriber(r).then(function () {
        ...
        return this._historyProvider.getBars(e.symbolInfo, e.resolution, {
            from: o,
            to: s,
            countBack: 2,
            firstDataRequest: !1
    ...
    var u = (o.prototype.subscribeQuotes = function (e, t, r, s) {
        this._subscribers[s] = {
            symbols: e,
            fastSymbols: t,
            listener: r
        ...
        if (!(0 < this._requestsPending)) {
            var t, o = this;
            for (t in this._subscribers) ! function (t) {
                o._requestsPending++;
                var r = o._subscribers[t];
                o._quotesProvider.getQuotes(1 === e ? r.fastSymbols : r.symbols).then(function (e) {
    ...
    var c = (h.prototype.resolveSymbol = function (t, r) {
        var s = this;
        ...
        return this._readyPromise.then(function () {
            var s = [],
                o = 0 === n.length;
            n = n.toUpperCase();
            for (var e = 0, t = c._symbolsList; e < t.length; e++) ! function (e) {
            ...
            var r = s.sort(function (e, t) {
                return e.weight - t.weight
            }).slice(0, u).map(function (e) {
                e = e.symbolInfo;
                return {
                    symbol: e.name,
        ...
        try {
            for (var e = r.symbol.length, o = void 0 !== r.ticker; s < e; ++s) {
                ...
                this._symbolsInfo[h] = l, this._symbolsInfo[n] = l, this._symbolsInfo[u] = l, void 0 !== c && (this._symbolsInfo[f(h, c)] = l, this._symbolsInfo[f(n, c)] = l, this._symbolsInfo[f(u, c)] = l), this._symbolsList.push(n)
            }
        } catch (e) {
    ...
    var d = (m.prototype.onReady = function (e) {
        var t = this;
        ...
        this._configuration.supports_marks && (o = {
            symbol: e.ticker || "",
            from: t,
            to: r,
            resolution: o
        }, this._send("marks", o).then(function (e) {
            if (!Array.isArray(e)) {
        ...
        this._configuration.supports_timescale_marks && (o = {
            symbol: e.ticker || "",
            from: t,
            to: r,
            resolution: o
        }, this._send("timescale_marks", o).then(function (e) {
            if (!Array.isArray(e)) {
                for (var t = [], r = 0; r < e.id.length; ++r) t.push({
                    id: l(e, "id", r),
                    time: l(e, "time", r),
        ...
        if (this._configuration.supports_group_request) {
            ...
            void 0 !== s && (e.currencyCode = s), this._send("symbols", e).then(function (e) {
        ...
        this._historyProvider.getBars(e, t, r).then(function (e) {
            s(e.bars, e.meta)
        }).catch(o)
    ...
    var b = (g.prototype.getQuotes = function (e) {
        var s = this;
        return new Promise(function (t, r) {
    ...
    var v = (P.prototype.sendRequest = function (e, t, r) {
        void 0 !== r && (0 !== (s = Object.keys(r)).length && (t += "?"), t += s.map(function (e) {
            return encodeURIComponent(e) + "=" + encodeURIComponent(r[e].toString())
        }).join("&"));
        var s = {
            credentials: "same-origin"
        };
        return void 0 !== this._headers && (s.headers = this._headers), fetch(e + "/" + t, s).then(function (e) {
            return e.text()
        }).then(function (e) {
            return JSON.parse(e)
        })
    ...
    var q, w, S, k = (r(w = I, S = q = d), w.prototype = null === S ? Object.create(S) : (x.prototype = S.prototype, new x), I);
    ...
    e.UDFCompatibleDatafeed = k, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});