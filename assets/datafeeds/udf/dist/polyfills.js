! function () {
    ...
    function o(r, n) {
        ...
        0 !== r._state ? (r._handled = !0, i._immediateFn(function () {
            var t, e = 1 === r._state ? n.onFulfilled : n.onRejected;
            if (null !== e) {
                try {
                    t = e(r._value)
                } catch (t) {
    ...
    t = window, e = setTimeout, i.prototype.catch = function (t) {
            ...
            return new i(function (o, i) {
                ...
                var s = a.length;
                for (var t = 0; t < a.length; t++) ! function e(r, t) {
                    try {
                        if (t && ("object" == typeof t || "function" == typeof t)) {
                            var n = t.then;
        ...
        function (t) {
            ...
            function v(t, e) {
                ...
                if (t instanceof v) {
                    ...
                    this.url = t.url, this.credentials = t.credentials, e.headers || (this.headers = new y(t.headers)), this.method = t.method, this.mode = t.mode, n || null == t._bodyInit || (n = t._bodyInit, t.bodyUsed = !0)
                } else this.url = String(t);
                if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new y(e.headers)), this.method = (r = e.method || this.method || "GET", t = r.toUpperCase(), -1 < f.indexOf(t) ? t : r), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && n) throw new TypeError("Body not allowed for GET or HEAD requests");
                this._initBody(n)
            }
            ...
            }, r && (y.prototype[Symbol.iterator] = y.prototype.entries), f = ["DELETE", "GET", "HEAD", "OPTIONS", "POST", "PUT"], v.prototype.clone = function () {
                return new v(this, {
                    body: this._bodyInit
                })
            ...
            }, h = [301, 302, 303, 307, 308], T.redirect = function (t, e) {
            ...
            }, t.Headers = y, t.Request = v, t.Response = T, t.fetch = function (r, i) {
                return new Promise(function (n, t) {
                    ...
                    o.onload = function () {
                        var r, t = {
                            ...
                            headers: (e = o.getAllResponseHeaders() || "", r = new y, e.split(/\r?\n/).forEach(function (t) {
                                var e = t.split(":"),
                                    t = e.shift().trim();
                        ...
                        t(new TypeError("Network request failed"))
                    }, o.open(e.method, e.url, !0), "include" === e.credentials && (o.withCredentials = !0), "responseType" in o && s && (o.responseType = "blob"), e.headers.forEach(function (t, e) {
