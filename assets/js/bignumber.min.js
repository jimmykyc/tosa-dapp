/* bignumber.js v9.0.1 https://github.com/MikeMcl/bignumber.js/LICENCE.md */ ! function (e) {
    ...
    function Q(e, r, n) {
        ...
        var d, a, h, n, l, m, s, f, u, c, g, t = _.prototype = {
                constructor: _,
                toString: null,
                valueOf: null
            },
        ...
        function i(e, r, n, t) {
            ...
            if (i = e.c[0], s = e.e, null == r) u = X(e.c), u = 1 == t || 2 == t && (s <= p || O <= s) ? K(u, s) : Q(u, s, "0");
            else if (o = (e = I(new _(e), r, n)).e, f = (u = X(e.c)).length, 1 == t || 2 == t && (r <= o || o <= p)) {
                for (; f < r; u += "0", f++);
                u = K(u, o)
        ...
        function I(e, r, n, t) {
            ...
            if (a) {
                e: {
                    ...
                    t ? (r -= e.e + 1, a[0] = h[(j - r % j) % j], e.e = -r || 0) : a[0] = e.e = 0,
                    e;
                    if (0 == o ? (a.length = l, f = 1, l--) : (a.length = l + 1, f = h[j - o], a[l] = 0 < s ? G(u / h[i - s] % h[s]) * f : 0), t)
                        for (;;) {
                            if (0 == l) {
        ...
        return _.clone = e, _.ROUND_UP = 0, _.ROUND_DOWN = 1, _.ROUND_CEIL = 2, _.ROUND_FLOOR = 3, _.ROUND_HALF_UP = 4, _.ROUND_HALF_DOWN = 5, _.ROUND_HALF_EVEN = 6, _.ROUND_HALF_CEIL = 7, _.ROUND_HALF_FLOOR = 8, _.EUCLID = 9, _.config = _.set = function (e) {
            ...
            if (null != e) {
                ...
                if (e.hasOwnProperty(r = "DECIMAL_PLACES") && (J(n = e[r], 0, V, r), v = n), e.hasOwnProperty(r = "ROUNDING_MODE") && (J(n = e[r], 0, 8, r), N = n), e.hasOwnProperty(r = "EXPONENTIAL_AT") && ((n = e[r]) && n.pop ? (J(n[0], -V, 0, r), J(n[1], 0, V, r), p = n[0], O = n[1]) : (J(n, -V, V, r), p = -(O = n < 0 ? -n : n))), e.hasOwnProperty(r = "RANGE"))
                    if ((n = e[r]) && n.pop) J(n[0], -V, -1, r), J(n[1], 1, V, r), y = n[0], b = n[1];
                    else {
            ...
            var r, n, t, i, o, s = 0,
                f = [],
                u = new _(w);
            if (null == e ? e = v : J(e, 0, V), i = M(e / j), E)
            ...
            var o, s, f, u, l, c, a, h, g = e.indexOf("."),
                p = v,
                w = N;
            ...
            if (g < 0 ? --f : (c.c = a, c.e = f, c.s = t, a = (c = d(c, h, p, w, n)).c, l = c.r, f = c.e), g = a[s = f + p + 1], u = n / 2, l = l || s < 0 || null != a[s + 1], l = w < 4 ? (null != g || l) && (0 == w || w == (c.s < 0 ? 3 : 2)) : u < g || g == u && (4 == w || l || 6 == w && 1 & a[s - 1] || w == (c.s < 0 ? 8 : 7)), s < 1 || !a[0]) e = l ? Q(o.charAt(1), -p, o.charAt(0)) : o.charAt(0);
            else {
                if (a.length = s, l)
            ...
            var o, s, f, u, l, c, a, h, g, p, w, d, m, v, N, O, y, b = e.s == r.s ? 1 : -1,
                E = e.c,
                A = r.c;
            ...
            if (A[f] > (E[f] || 0) && s--, b < 0) g.push(1), u = !0;
                ...
                do {
                    if (l = 0, (o = P(A, p, O, w)) < 0) {
                        if (d = p[0], O != w && (d = d * i + (p[1] || 0)), 1 < (l = G(d / N)))
                            for (i <= l && (l = i - 1), a = (c = D(A, l, i)).length, w = p.length; 1 == P(c, p, a, w);) l--, x(c, O < a ? y : A, a, i), a = c.length, o = 1;
                        else 0 == l && (o = l = 1), a = (c = A.slice()).length;
                        if (a < w && (c = [0].concat(c)), x(p, c, w, i), w = p.length, -1 == o)
                            for (; P(A, p, O, w) < 1;) l++, x(p, O < w ? y : A, w, i), w = p.length
                    } else 0 === o && (l++, p = [0]);
            ...
            var n, t, i, o, s, f, u, l, c, a, h, g, p, w, d, m = this,
                v = m.c,
                N = (e = new _(e, r)).c;
            ...
            if ((n = 0 == (f = Math.sqrt(+T(o))) || f == 1 / 0 ? (((r = X(s)).length + u) % 2 == 0 && (r += "0"), f = Math.sqrt(+r), u = W((u + 1) / 2) - (u < 0 || u % 2), new _(r = f == 1 / 0 ? "5e" + u : (r = f.toExponential()).slice(0, r.indexOf("e") + 1) + u)) : new _(f + "")).c[0])
                for ((f = (u = n.e) + l) < 3 && (f = 0);;)
                    if (i = n, n = c.times(i.plus(d(o, i, l, 1))), X(i.c).slice(0, f) === (r = X(n.c)).slice(0, f)) {
            ...
            var r, n, t, i, o, s, f, u, l, c, a, h, g = this,
                p = g.c;
